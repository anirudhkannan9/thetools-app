    ...
    return (
        <Container>
            ...
            <InstructionContainer>
                <InstructionText>
                    You will feel the cloud spit you out and close behind you. Say inwardly with
                    conviction, <InstructionText style={{ fontFamily: 'Poppins-BoldItalic'}}>"FEAR SETS ME FREE!"</InstructionText> As 
                    you leave the cloud, feel yourself propelled forward into a realm of pure light. 
                </InstructionText>
            </InstructionContainer>
